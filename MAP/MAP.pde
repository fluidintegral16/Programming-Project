...
class Map {
  MapButton[] buttons = new MapButton[21];
  int btnSize = 70;
  int margin = 20;
  PImage currentImage;
  ...
  void draw() {
    ...
    //float adjMouseX = (mouseX - width/2 + testimages.xPan) / testimages.scale;
    //float adjMouseY = (mouseY - height/2 + testimages.yPan) / testimages.scale;
    currentImage = null;
